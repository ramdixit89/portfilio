  ...
  return (
    <section id="about" className="py-5 bg-light text-dark">
      <div className="container">
        ...
        <div className="row align-items-center text-justify text-md-start">
          <div className="col-12 col-md-5 mb-4 mb-md-0" data-aos="fade-right">
            <img
              src={myImage}
              alt="Ram Dixit"
              className="img-fluid rounded-circle shadow border border-3 border-primary mx-auto d-block"
